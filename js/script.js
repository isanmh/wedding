      ...
      async function loadMessages() {
        ...
        try {
          ...
          if (result.status === "success" && Array.isArray(result.data)) {
            // Urutkan DESC berdasarkan tanggal/waktu isi ucapan (bukan sekadar
            // membalik urutan array), supaya ucapan yang baru saja disubmit
            // pasti tampil paling atas dan langsung terlihat oleh user.
            messagesData = result.data.slice().sort((a, b) => {
